...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private TMP_ColorGradient defaultTextColor;
        
        private TMP_ColorGradient lastTextColor;
        //Color
        [SerializeField]
        private TMP_ColorGradient unlockedTextColor;
        [SerializeField]
        private TMP_ColorGradient hoverTextColor;

        private bool changeHoverColorNext = true;
        [SerializeField]
